  ...
  return (
    <>
      ...
      >
        ...
        <tbody>
          <tr className="1">
            <td style={{ border: "1px black solid" }}><span>1. </span>英語の授業中、教師は英語のみで教えるべきだ。</td>
          ...
          <tr className="2">
            <td style={{ border: "1px black solid" }}><span>2. </span>英語の例文や文章の音読をもっと取り入れるべきだ。</td>
          ...
          <tr className="3">
            <td style={{ border: "1px black solid" }}><span>3. </span>中学英語段階で基本の発音記号は教えておくべきだ。</td>
          ...
          <tr className="4">
            <td style={{ border: "1px black solid" }}><span>4. </span>英語の授業では、英語らしく発音しなければならない環境を作るべきだ。</td>
